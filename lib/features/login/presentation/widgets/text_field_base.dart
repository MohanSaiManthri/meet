...
Widget getTextField(String label,
    ...
    TextFormField(
        ...
        validator: (value) => label == passwordConst
...
String validateEmail(String value) {
  return isEmailCompliant(value.trim()) ? null : emailErrorMsg;
}

String validatePassword(String value) {
  return isPasswordCompliant(value.trim()) ? null : passwordErrorMsg;
}
...
const emailConst = 'Enter your email or mobile number';
